...
## 3. 수정 계획
- 기능 : 현재는 프로젝트 내에서 관리자가 업로드한 이미지에 대해서만 상호작용 할 수 있지만, 사용자들이 직접 올릴 수 있도록 업로드 기능을 추가할 예정, 그리고 답변에 대한 수정, 삭제 추천 기능과 답변들을 추천 순으로 정렬하는 기능도 필요함

- 구조 : 템플릿의 상속 구조와 부트스트랩, CSS 구조를 정리할 필요가 있으며 페이지 디자인도 좀 더 수정이 필요
